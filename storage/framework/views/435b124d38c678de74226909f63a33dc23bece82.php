...
<?php $__env->startSection('contents'); ?>
    ...
    <form action="<?php echo e(route('transfert.multiple')); ?>" method="POST" role="form" autocomplete="off" onsubmit='return show_alert();'>
    <?php echo csrf_field(); ?>
    <div class="row">
            ...
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <div id="basic-form">
                        ...
                        <input type="text" class="form-control numero" name ="nfacture" placeholder="<?php echo e(@\App\Entre::sortie()->orderBy('created_at','desc')->first()->nfacture); ?>" required>
        ...
        <div class="col-md-8 portlets ui-sortable">
            <div class="widget">
                ...
                <div class="widget-content padding">
                        ...
                        <div id="materiel">
                    <div class="mat">
                        <div class="form-group col-md-10 <?php if($errors->has('type_id')): ?> has-error <?php endif; ?>">
                      ...
                      <div class="form-group col-md-2 <?php if($errors->has('quantite')): ?> has-error <?php endif; ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/stockv1/resources/views/transferts/multiple.blade.php ENDPATH**/ ?>