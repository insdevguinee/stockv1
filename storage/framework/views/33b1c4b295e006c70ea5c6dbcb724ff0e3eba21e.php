      ...
      <div class="col-md-12">
        <div class="panel panel-default widget">
          <div class="widget-header">
            ...
            <h2 class="text-center"><strong>Entrée de Marchandise</strong></h2>
            <div class="additional-btn">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('add_entremultiple')): ?>
            <a class="btn btn-success text-light" href="<?php echo e(route('entre.multiple')); ?>" style="color: #fff;">Ajouter Plusieurs</a>
            <?php endif; ?>
                    ...
                    <tr class="entre">
                       <td><?php echo $entre->nfacture.$transfert; ?></td>
                        ...
                        <td>
                          ...
                          <?php else: ?>
                          <?php echo e("Chantier ".\App\Chantier::findOrFail($entre->transfert_id)->name); ?>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" >Entrée de Marchandise</h5>
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo e(route('entres.store')); ?>" method="POST" role="form" autocomplete="off">
              ...
              <div class="form-group <?php if($errors->has('nfacture')): ?> has-error <?php endif; ?>">
                <label for="nfacture">N°BON DE COMMANDE</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/stockv1/resources/views/stocks/entre.blade.php ENDPATH**/ ?>