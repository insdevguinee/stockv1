...
<div class="" style="background-color: #fff;padding: 20px;">
	<div class="row">
		...
		<p class="text-right">Conakry le <?php echo e(explode('00:00',\Carbon\Carbon::parse($bon->date_execution,'UTC')->locale('fr_FR')->isoFormat('LLLL'))[0]); ?></p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/damaro/Bureau/stockv1/resources/views/bons/view.blade.php ENDPATH**/ ?>