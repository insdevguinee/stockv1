...
<html>
    <head>
        <meta charset="UTF-8">
        <title>404 - <?php echo e(env('APP_NAME')); ?></title>
...
<div id="wrapper">
    ...
    <div class="content">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h2>Erreur 404</h2> <br> Page introuvable
            </div>
        </div>
    </div>
  ...
  <!-- End of eoverlay modal -->
    ...
    <script src="<?php echo e(URL::to('assets/libs/bootstrap-select2/select2.min.js')); ?>"></script>
...
<?php endif; ?><?php /**PATH /home/damaro/Bureau/stockv1/resources/views/errors/404.blade.php ENDPATH**/ ?>