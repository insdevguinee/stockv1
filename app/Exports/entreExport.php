...
class entreExport implements FromCollection,ShouldAutoSize,WithTitle
{
    /**
    ...
    */
    ...
    {
  		$entres = Entre::entre()->whereBetween('date_ajout', [$this->min, $this->max])->orderBy('date_ajout','asc')->get();
