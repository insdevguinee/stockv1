            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form action="{{route('demande.new')}}" method="POST">
                                @csrf
            ...
            @foreach ($demandes as $demande)
                <li>
                    <a href="?demande={{$demande->id}}">
                        {{$demande->type}} - {{$demande->titre}} ({{$demande->status}})
                    </a>
                </li>
            @endforeach
        </ul>
    ...
    <div class="col-md-8">
        <div class="widget">
            ...
            <div class="widget-header transparent">
                <h2>{{$d->type}}<strong>{{$d->titre}} </strong> <span class="badge badge-info"> {{$d->status}} </span> </h2>
            </div>
            <div class="widget-content padding">
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <form action="{{route('demande.annuler',$d->id)}}" method="POST">
                            @csrf
             ...
             <small>creer le <i>{{$d->created_at}}</i></small>
            @endif
        </div>
