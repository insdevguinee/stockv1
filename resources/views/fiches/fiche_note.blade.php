...
<div class="d-grid gap-2 mb-2" style="margin-bottom: 10px">
    @isset($p)
        <a href="{{route('evaluation.show',[$p,'fiche'=>$fiche->id])}}"  class="btn btn-primary float-right btn-sm">< Précedent</a>
    @endisset
    <span>PERSONNEL</span>
    @isset($n)
    <a href="{{route('evaluation.show',[$n,'fiche'=>$fiche->id])}}"  class="btn btn-primary float-left btn-sm">Suivant ></a>
    @endisset
</div>
@endauth
...
<div class="d-grid gap-2 mb-2" style="margin-top: 10px">
    @isset($p)
